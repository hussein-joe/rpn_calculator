...
public class CalculatorProcessorTest {
    ...
    public void shouldWriteResultOfCalculationToOutputStream() {
        ...
        when(calculator.evaluate(userInput, session)).thenReturn(expectedResult);
    ...
    public void shouldWrite2ResultsOfCalculationsWhenPass2UserInputs() {
        ...
        String userInput2 = "4 *";
        when(calculator.evaluate(userInput1, session)).thenReturn(expectedResult1);
        when(calculator.evaluate(userInput2, session)).thenReturn(expectedResult2);
